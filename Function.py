# -*- coding: utf-8 -*-
"""
Created on Thu Feb  6 08:59:53 2025
...
def Clean(data):
    ...
    data['email_of_borrower'] = data['email_of_borrower'].str.replace('No email','No_Email')
    data['highest_education_level'] = data['highest_education_level'].str.replace('Not Available','Not_Available')
    ...
    data['Tenure_of_loan']= data['Tenure_of_loan']/30
    ...
    data['Expected_monthly_installment']= data['Expected_monthly_installment'].str.replace(',','')
    data['Expected_monthly_installment']= pd.to_numeric(data['Expected_monthly_installment'])
    data['Expected_monthly_installment']= data['Expected_monthly_installment'].astype(int)
    ...
    #Create a new column "Activity" that joins Loan purpose and Line of Business
